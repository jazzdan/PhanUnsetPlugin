...
class UnsetPlugin extends PluginImplementation {
    /**
    ...
    public function analyzeNode(
        ...
        (new UnsetVisitor($code_base, $context, $this))(
            $node
        );
    }
}

class UnsetVisitor extends AnalysisVisitor {
    /** @var Plugin */
    private $plugin;
    ...
    public function visitUnset(Node $node) {
        $this->plugin->emitIssue(
            ...
            $this->context,
            'PhanPluginUnset',
            '`unset` is not allowed. Set the variable to null to achieve the same effect'
        );
    }

}

return new UnsetPlugin();
